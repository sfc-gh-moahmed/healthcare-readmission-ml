...
--
-- PREREQUISITE: You already have the GITHUB_API_INTEGRATION configured for
-- https://github.com/sfc-gh-moahmed/. This script reuses that integration
-- (same pattern as the icd10-llmops-dbt repo).
--
...
-- -----------------------------------------------------------------------------
-- The GITHUB_API_INTEGRATION allows HTTPS access to repos under
-- https://github.com/sfc-gh-moahmed/. If the repo is PUBLIC, no secret
